...
To wake up AM2315 Temp/Humid sensor, run the command again. You must run this command quick after the previous. It will show all addresses - 0x3C, 0x5B, 0x5C. 
